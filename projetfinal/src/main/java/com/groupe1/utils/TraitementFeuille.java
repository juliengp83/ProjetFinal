...
public class TraitementFeuille {
    ...
    public static Regle testRegle1(ArrayList<EmployeProjet> employe_projets) {
        // Test #1 : Les employes de l'administration (numero_employe est INFERIEUR à 1000) 
        // doivent travailler AU MOINS 36 heures au bureau par semaine (code_projet INFERIEUR à 900).
        // faire les test
        ...
        if (numero_employe > 1000) {
            message = "Il s'agit d'un employé normal qui n'est assujeti par le règle 1.";
        }
        else {
